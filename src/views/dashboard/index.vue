  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imagerror="defaultImg" :src="avatar">
          </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="applyBtn">加班离职</el-button>
    ...
    <!-- 离职弹层 -->
    <work-apply :show-apply-dialog.sync="showApplyDialog" />
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      defaultImg: 'https://img2.baidu.com/it/u=503527429,390831611&fm=253',
      showApplyDialog: false// 控制 离职和加班  申请弹层
    }
  },
  computed: {
    ...mapGetters([
